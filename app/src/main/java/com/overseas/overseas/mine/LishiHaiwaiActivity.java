...
public class LishiHaiwaiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lishi_haiwai);
        ...
        OkGo.<ZhongGuoDetailsBean>post(MyUrls.BASEURL + "/app/oiverseas/houseinfo")
                ...
                .execute(new DialogCallback<ZhongGuoDetailsBean>(this, ZhongGuoDetailsBean.class) {
                    ...
                    public void onSuccess(Response<ZhongGuoDetailsBean> response) {
                        ...
                        Glide.with(LishiHaiwaiActivity.this).load(hwdcBroker.getPic() + "").into(tvDetailsManagerHead);
                        isSc = datas.getIsSc();
                        if (isSc == 0) {//收藏
                            isStart = true;
    ...
    private void initData() {
        findViewById(R.id.haiwai_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hwdcBroker != null){
                    ImManager.enterChatDetails(LishiHaiwaiActivity.this, hwdcBroker.getId() + "", hwdcBroker.getBrokerName(), hwdcBroker.getPic());
                }
            }
        });
    ...
    private void showHuxingDialog(int position) {
        ...
        Glide.with(LishiHaiwaiActivity.this).load(huxinglist.get(position)).into(img_dialog_huxing);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_details_location:
                ...
                //检测地图是否安装和唤起
                if (checkMapAppsIsExist(LishiHaiwaiActivity.this, BAIDU_PKG)) {
//                    Toast.makeText(mContext,getResources().getString(R.string.zhengzaidakaibaiduditu), Toast.LENGTH_SHORT).show();
                    Toast.makeText(LishiHaiwaiActivity.this, "后台没给经纬度", Toast.LENGTH_SHORT).show();
...
//                    startActivity(intent);
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(LishiHaiwaiActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            ...
                            Toast.makeText(LishiHaiwaiActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//        });
    ...
    class LiebiaoAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, String item) {
            Glide.with(LishiHaiwaiActivity.this).load(item).into((ImageView) helper.getView(R.id.img_huxing));
