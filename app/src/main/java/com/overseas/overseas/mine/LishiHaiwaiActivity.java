...
public class LishiHaiwaiActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        HuxingRecycler.setLayoutManager(new GridLayoutManager(LishiHaiwaiActivity.this, 3));
        HuxingRecycler.setNestedScrollingEnabled(false);
        HuxingRecycler.setAdapter(mLiebiaoAdapter);
        mLiebiaoAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Toast.makeText(LishiHaiwaiActivity.this, "点击了第" + position + "条", Toast.LENGTH_SHORT).show();
            }
        });
    }
