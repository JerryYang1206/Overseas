...
import com.overseas.overseas.bean.TudiDetailsBean;
import com.overseas.overseas.callback.DialogCallback;
import com.overseas.overseas.im.ImManager;
import com.overseas.overseas.more.TudiMoreActivity;
...
public class LishiTudiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lishi_tudi);
        //拉伸图片覆盖标题栏
        ...
        OkGo.<TudiDetailsBean>post(MyUrls.BASEURL + "/app/land/landinfo")
                ...
                .execute(new DialogCallback<TudiDetailsBean>(this, TudiDetailsBean.class) {
                    ...
                    public void onSuccess(Response<TudiDetailsBean> response) {
                        ...
                        Log.d("LishiTudiActivity", landImgs);
                        hwdcBroker = datas.getHwdcBroker();
                        isJa = MyUtils.isJa(mContext);
                        ...
                        Glide.with(LishiTudiActivity.this).load(hwdcBroker.getPic() + "").into(tvDetailsManagerHead);
                        isSc = datas.getIsSc();
                        if (isSc == 0) {//收藏
                            isStart = true;
    ...
    private void initData() {
        findViewById(R.id.tudi_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hwdcBroker != null) {
                    ImManager.enterChatDetails(LishiTudiActivity.this, hwdcBroker.getId() + "", hwdcBroker.getBrokerName(), hwdcBroker.getPic());
                }
            }
        });
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.manager_data:
                Intent Managerintent = new Intent(LishiTudiActivity.this, ManagerActivity.class);
            ...
            case R.id.tv_details_location:
                ...
                //检测地图是否安装和唤起
                if (checkMapAppsIsExist(LishiTudiActivity.this, BAIDU_PKG)) {
            ...
            case R.id.tv_See_More:
                Intent intent = new Intent(LishiTudiActivity.this, TudiMoreActivity.class);
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(LishiTudiActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            ...
                            Toast.makeText(LishiTudiActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
