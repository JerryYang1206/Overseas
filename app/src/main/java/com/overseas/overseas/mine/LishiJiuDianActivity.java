...
import com.overseas.overseas.more.JiuDianMoreActivity;
...
public class LishiJiuDianActivity extends BaseActivity {
...
//        if (houseId!=null&&!houseId.equals("")){
        ...
        OkGo.<ShangYeDetailsBean>post(MyUrls.BASEURL + "/app/realestate/realestateinfo")
                ...
                .execute(new DialogCallback<ShangYeDetailsBean>(this, ShangYeDetailsBean.class) {
                    ...
                    public void onSuccess(Response<ShangYeDetailsBean> response) {
                        ...
                        Glide.with(LishiJiuDianActivity.this).load(hwdcBroker.getPic() + "").into(tvDetailsManagerHead);
                        isSc = datas.getIsSc();
                        if (isSc == 0) {//收藏
                            isStart = true;
    ...
    private void initData() {
        findViewById(R.id.jiudian_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hwdcBroker != null) {
                    ImManager.enterChatDetails(LishiJiuDianActivity.this, hwdcBroker.getId() + "", hwdcBroker.getBrokerName(), hwdcBroker.getPic());
                }
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.manager_data:
                Intent Managerintent = new Intent(LishiJiuDianActivity.this, ManagerActivity.class);
            ...
            case R.id.tv_details_location:
                ...
                //检测地图是否安装和唤起
                if (checkMapAppsIsExist(LishiJiuDianActivity.this, BAIDU_PKG)) {
            ...
            case R.id.tv_See_More:
                Intent intent = new Intent(LishiJiuDianActivity.this, JiuDianMoreActivity.class);
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(LishiJiuDianActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            ...
                            Toast.makeText(LishiJiuDianActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
