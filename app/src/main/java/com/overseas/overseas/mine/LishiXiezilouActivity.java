...
public class LishiXiezilouActivity extends BaseActivity {
        ...
        OkGo.<ShangYeDetailsBean>post(MyUrls.BASEURL + "/app/realestate/realestateinfo")
                ...
                .execute(new DialogCallback<ShangYeDetailsBean>(this, ShangYeDetailsBean.class) {
                    ...
                    public void onSuccess(Response<ShangYeDetailsBean> response) {
                        ...
                        Glide.with(LishiXiezilouActivity.this).load(hwdcBroker.getPic() + "").into(tvDetailsManagerHead);
                        isSc = datas.getIsSc();
                        if (isSc == 0) {//收藏
                            isStart = true;
    ...
    private void initData() {
        findViewById(R.id.xiezilou_wl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hwdcBroker != null) {
                    ImManager.enterChatDetails(LishiXiezilouActivity.this, hwdcBroker.getId() + "", hwdcBroker.getBrokerName(), hwdcBroker.getPic());
                }
            }
        });
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.manager_data:
                Intent Managerintent = new Intent(LishiXiezilouActivity.this, ManagerActivity.class);
            ...
            case R.id.tv_details_location:
                ...
                //检测地图是否安装和唤起
                if (checkMapAppsIsExist(LishiXiezilouActivity.this, BAIDU_PKG)) {
            ...
            case R.id.tv_See_More:
                Intent intent = new Intent(LishiXiezilouActivity.this, XieZiLouMoreActivity.class);
    ...
    private void initStart() {
        ...
        OkGo.<SuccessBean>post(MyUrls.BASEURL + "/app/collectionhouse/insertcollectionhouse")
                .tag(this)
                .params(params)
                .execute(new DialogCallback<SuccessBean>(LishiXiezilouActivity.this, SuccessBean.class) {
                    @Override
                    public void onSuccess(Response<SuccessBean> response) {
                        ...
                        if (code1.equals("200")) {
                            ...
                            Toast.makeText(LishiXiezilouActivity.this, code1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
